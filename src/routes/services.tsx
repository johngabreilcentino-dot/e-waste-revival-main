...
const serviceImages = {
  ...
  cta: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=1400&q=80",
};
  ...
  head: () => ({
    meta: [
      { title: "Services — e-waste ready" },
      {
        name: "description",
        content:
          "Appliance collection drives, business pickup, education programs, and policy resources.",
      },
    ],
  }),
...
const services = [
  {
    icon: Truck,
    t: "Household appliance pickup",
    d: "Schedule a drop-off or pickup for old refrigerators, microwaves, washing machines, fans, and more.",
    image: serviceImages.pickup,
  },
  {
    icon: Building2,
    t: "Business partnerships",
    d: "Compliant appliance disposal programs for offices, schools, food stalls, and small businesses.",
    image: serviceImages.business,
  },
  {
    icon: GraduationCap,
    t: "Education programs",
    d: "Workshops for schools, LGUs, and barangays on safe handling and appliance waste disposal.",
    image: serviceImages.education,
  },
  {
    icon: Recycle,
    t: "Policy advocacy",
    d: "Resources, briefings, and campaigns to keep regional policies moving forward.",
    image: serviceImages.policy,
  },
];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        ...
        <h1 className="mt-3 text-5xl sm:text-6xl font-semibold text-foreground max-w-3xl leading-tight">
          Appliance recycling services for every Filipino household and business.
        </h1>
        ...
        <div className="mt-14 grid md:grid-cols-2 gap-6">
          {services.map(({ icon: Icon, t, d, image }) => (
            <div
              key={t}
              className="overflow-hidden rounded-3xl bg-card border border-border hover:shadow-elevated transition-shadow group"
            >
        ...
        <div className="mt-16 grid overflow-hidden rounded-[2rem] border border-border bg-card shadow-elevated lg:grid-cols-[1.1fr_0.9fr]">
          <div className="p-12">
            ...
            <p className="mt-3 max-w-xl text-muted-foreground">
              Contact our team to schedule an appliance pickup or set up a partnership for your
              organization.
            </p>
            <Link
              to="/contact"
